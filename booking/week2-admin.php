                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        if ($date_settimana2 != "") {
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Posti Selezionati: " . implode(", ", $posti_selezionati) . "</p>";
                            echo "<p style=\"margin:4px; color: #f29240;\"><strong>SETTIMANA 2:</strong> $date_settimana2</p>";
                        }
                        if ($date_settimana3 != "") {
                        ...
                        <form method="POST" action="confermaPrenotazione.php" id="mainForm">
                            ...
                            <label for="nlettini_settimana2">Seleziona la q.tà di Ombrelloni</label>
                            ...
                            <div class="">
                                ...
                                <label for="">Seleziona l'ombrellone per la seconda settimana:</label>
                            ...
                            <div id="additionalOmbrelloni">
                                ...
                                if (isset($_POST['nlettini_settimana2'])) {
                                    ...
                                    if ($n_ombrelloni >= 2) {
                                        echo "<label for=\"posto2week2\">Seleziona l'ombrellone aggiuntivo:</label>";
                                    ...
                                    if ($n_ombrelloni == 3) {
                                        echo "<label for=\"posto3week2\">Seleziona l'ombrellone aggiuntivo 2:</label>";
                            ...
                            <input type="hidden" name="date_settimana1" value="<?php echo $date_settimana1; ?>">
                            ...
                            <input type="hidden" name="date_settimana2" value="<?php echo $date_settimana2; ?>">

                            <!-------- SETTIMANA 3 ---------->
                            <input type="hidden" name="id_settimana3" value="<?php echo $id_settimana3; ?>">
                            <input type="hidden" name="date_settimana3" value="<?php echo $date_settimana3; ?>">
...
<script>
    ...
    function updateMapHighlight() {
        ...
        const selectedposto1week2s = [
            document.getElementById('posto1week2').value, // Valore del primo selettore
            document.getElementById('posto2week2') ? document.getElementById('posto2week2').value : null, // Valore del secondo selettore, se esiste
            document.getElementById('posto3week2') ? document.getElementById('posto3week2').value : null // Valore del terzo selettore, se esiste
        ];

        // Evidenzia gli ombrelloni selezionati sulla mappa
        selectedposto1week2s.forEach(posto1week2 => {
            if (posto1week2) { // Se esiste un valore selezionato
                const circle = document.querySelector(`.circle[data-seat="${posto1week2}"]`); // Trova l'elemento della mappa corrispondente
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const posto1week2Selects = ['posto1week2', 'posto2week2', 'posto3week2']; // Array degli ID dei selettori
        posto1week2Selects.forEach((id) => { // Per ogni ID nell'array
            ...
            if (select) { // Se il selettore esiste
                updateOptions(select, 'posto1week2', 'posto2week2', 'posto3week2'); // Aggiorna le opzioni dei selettori
            }
        });
    });
    ...
    function submitForm() {
        ...
        if (numWeeks === 2) {
            form.action = "confermaPrenotazione-admin.php";
        } else if (numWeeks >= 3) {
            form.action = "week3-admin.php";
        } else {
    ...
    function submitFormBack() {
        ...
        form.action = "week1-admin.php"; // Sostituisci con la pagina corretta
