            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="form-container">
                        <h2 class="text-body-emphasis">Enter Your Booking Details!</h2>
                        ...
                        <form method="POST" id="mainForm">
                            ...
                            <label for="codicePrenotazione">Booking Code</label>
                            ...
                            <label for="weeks">Booked Week <small>[from Saturday to Friday]</small></label>
                            ...
                            <label for="numWeeks">Qty. Weeks Booked</label>
                            ...
                            <label for="nomeCognome">Full Name</label>
...
<script>
    ...
    // Funzione per inviare il form con validazione
    // function submitForm() {
    ...
    //         // Se tutti i campi obbligatori sono compilati, procedi
    //         document.getElementById('mainForm').action = "week1.php";
    //         document.getElementById('mainForm').submit();
    //     } else {
    //         // Mostra un avviso se mancano campi obbligatori
    ...
    function submitForm() {
        ...
        if (!nomeCognomePattern.test(nomeCognome)) {
            alert("Enter at least a First Name and Last Name separated by a space.");
        ...
        if (!telefonoPattern.test(telefono)) {
            alert("Enter a valid phone number (at least 8 digits, can contain +, spaces, -, .).");
            telefonoField.focus();
            return;
        }

        // Se tutti i controlli sono superati, invia il modulo
        document.getElementById('mainForm').action = "week1-en.php";
        document.getElementById('mainForm').submit();
    }
