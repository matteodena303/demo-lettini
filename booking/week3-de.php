            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        echo "<p style=\"margin:4px; padding-bottom:6px;\"><strong>Buchungscode:</strong> $codicePrenotazione</p>";
                        if ($numWeeks == 1) {
                        ...
                        if ($date_settimana2 != "") {
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Ausgewählte Plätze: " . implode(", ", $posti_selezionati1) . "</p>";
                            echo "<p style=\"margin:4px 4px 0px 4px;\"><strong>WOCHE 2:</strong> $date_settimana2</p>";
                            $posti_selezionati2 = [];
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Ausgewählte Plätze: " . implode(", ", $posti_selezionati2) . "</p>";
                        }
                        if ($date_settimana3 != "") {
                            $date_settimana3 = getFormattedWeekRange($id_settimana3);
                            echo "<p style=\"margin:4px;color: #f29240;\"><strong>WOCHE 3:</strong> $date_settimana3</p>";
                        }
                        ?>
                        ...
                        <form method="POST" action="confermaPrenotazione.php" id="mainForm">
                            ...
                            <!-- Label in tedesco -->
                            <label for="nlettini_settimana3">Wählen Sie die Anzahl der Sonnenschirme</label>
                            ...
                            <div class="">
                                <label for="">Wählen Sie den Sonnenschirm für die dritte Woche:</label>
                            ...
                            <div id="additionalOmbrelloni">
                                ...
                                if (isset($_POST['nlettini_settimana3'])) {
                                    ...
                                    if ($n_ombrelloni >= 2) {
                                        echo "<label for=\"posto2week3\">Wählen Sie einen zusätzlichen Sonnenschirm:</label>";
                                    ...
                                    if ($n_ombrelloni == 3) {
                                        echo "<label for=\"posto3week3\">Wählen Sie einen zweiten zusätzlichen Sonnenschirm:</label>";
...
<script>
    ...
    function updateOptions(changedSelect) {
        ...
        // Ripristiniamo tutte le opzioni disponibili nei select
        ...
        // Aggiorna la mappa evidenziando i posti selezionati
        updateMapHighlight();
    }
        ...
        if (selectElement) {
            for (let option of selectElement.options) {
                if (selectedValues.includes(option.value) && option.value !== selectElement.value) {
                    option.style.display = "none"; // Nasconde l'opzione se è già selezionata in un altro menu
                }
            }
        }
    }
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const posto1week3Selects = ['posto1week3', 'posto2week3', 'posto3week3'];
        posto1week3Selects.forEach((id) => {
            const select = document.getElementById(id);
            if (select) {
                updateOptions(select, 'posto1week3', 'posto2week3', 'posto3week3');
            }
        });
    });
    ...
    function submitForm() {
        ...
        // Qualunque sia il numero di settimane, qui concludiamo
    ...
    function submitFormBack() {
        ...
        // Torna indietro alla pagina week2
        form.action = "week2-de.php"; // Sostituisci con la pagina corretta
