...
<body>
    <div class="col-lg-8 mx-auto p-4 py-md-5">
        <main style="padding-bottom:100px;">
            <div class="row g-5">
                <div class="col-md-12">
                    <h2 class="text-body-emphasis">Buchung best&auml;tigen</h2>
                    <p class="form-bold">SCHRITT 3<br><br></p>
                    ...
                    if ($stmt->num_rows > 0) {
                        ...
                        echo "<p style='color: #ff6666; font-size: xx-large;font-weight: 700;'>ACHTUNG: Dieser Buchungscode ist bereits vorhanden!</p>";
                        $stmt->close();
                        ...
                        $stmt = $conn->prepare("INSERT INTO clienti (nome_cliente, email, telefono, lingua, data_inserimento) 
                                                VALUES (?, ?, ?, ?, NOW())");
                        if (!$stmt) {
                            die("<p style='color: red;'>Fehler bei der Vorbereitung der Kundenabfrage: " . $conn->error . "</p>");
                        }
                        $stmt->bind_param("ssss", $nomeCognome, $email, $telefono, $language);
                        if (!$stmt->execute()) {
                            die("<p style='color: red;'>Fehler beim Einf&uuml;gen des Kunden: " . $stmt->error . "</p>");
                        }
                        ...
                        if (!$stmt) {
                            die("<p style='color: red;'>Fehler bei der Vorbereitung der Buchungsabfrage: " . $conn->error . "</p>");
                        }
                        ...
                        if ($stmt->execute()) {
                            echo "<p style='color: #72c772;font-size: xxx-large;font-weight: bold;'>Ihre Buchung wurde erfolgreich eingetragen!</p>";
                            echo "<p>Sie erhalten in K&uuml;rze eine Zusammenfassungs-E-Mail.</p>";
                            ...
                            switch ($language) {
                                ...
                                case 'DEU':
                                    ...
                                    $messageCliente .= "<b>Die Buchung muss noch vom Reservierungsb&uuml;ro best&auml;tigt werden.</b>\n";
                                    $messageCliente .= "Sie erhalten innerhalb weniger Werktage eine Best&auml;tigung per E-Mail.\n\n";
                                    ...
                                    $messageCliente .= "\n\nMit freundlichen Gr&uuml;&szlig;en vom Team.\n\nF&uuml;r weitere Informationen oder Anfragen kontaktieren Sie uns bitte per E-Mail unter info@bibioneresidence.it.";
                                    break;
                            ...
                            die("<p style='color: red;font-size: xx-large;'>ACHTUNG: Bei der Buchungseintragung ist ein Fehler aufgetreten: "
                                . $stmt->error . "</p><br>"
                                . "<p style='color: red;'>Kontaktieren Sie uns per E-Mail unter info@bibioneresidence.it, um das Problem zu melden und zu lösen.</p>");
                        }
