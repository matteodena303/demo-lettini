                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        if ($date_settimana2 != "") {
                            ...
                            echo "<p style=\"margin:4px; color: #f29240;\"><strong>WOCHE 1:</strong> $date_settimana1</p>";
                            echo "<p style=\"margin:4px\"><strong>WOCHE 2:</strong> $date_settimana2</p>";
                        }
                        if ($date_settimana3 != "") {
                        ...
                        <form method="POST" action="confermaPrenotazione.php" id="mainForm">
                            ...
                            <!-- Label in tedesco -->
                            <label for="nlettini_settimana1">Wählen Sie die Anzahl der Sonnenschirme</label>
                            ...
                            <div class="posto1week1-selection">
                                <?php
                                if ($numWeeks == 1) {
                                    echo "<label for=\"posto1week1\">Wählen Sie den Sonnenschirm:</label>";
                                } else {
                                    echo "<label for=\"posto1week1\">Wählen Sie den Sonnenschirm für die erste Woche:</label>";
                                }
                                ?>
                            ...
                            <div id="additionalOmbrelloni">
                                ...
                                if (isset($_POST['nlettini_settimana1'])) {
                                    ...
                                    if ($n_ombrelloni >= 2) {
                                        echo "<label for=\"posto2week1\">Wählen Sie einen zusätzlichen Sonnenschirm:</label>";
                                    ...
                                    if ($n_ombrelloni == 3) {
                                        echo "<label for=\"posto3week1\">Wählen Sie einen zweiten zusätzlichen Sonnenschirm:</label>";
...
<script>
    ...
    function updateOptions(changedSelect) {
        ...
        // ✅ Ora updateMapHighlight viene sempre chiamato
        updateMapHighlight();
    }
        ...
        if (selectElement) {
            for (let option of selectElement.options) {
                if (selectedValues.includes(option.value) && option.value !== selectElement.value) {
                    option.style.display = "none"; // Nasconde l'opzione se è già selezionata altrove
                }
            }
        }
    }
    ...
    function submitFormBack() {
        ...
        form.action = "index-de.php"; // Sostituisci con la pagina corretta
