            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        echo "<p style=\"margin:4px\"><strong>Booking Code:</strong> $codicePrenotazione</p>";
                        if ($numWeeks == 1) {
                            echo "<p style=\"margin:4px; color: #f29240;\"><strong>Booking Dates:</strong> $date_settimana1</p>";
                        }
                        if ($date_settimana2 != "") {
                            $date_settimana2 = getFormattedWeekRange($id_settimana2);
                            echo "<p style=\"margin:4px 4px 0px 4px;\"><strong>WEEK 1:</strong> $date_settimana1</p>";
                            $posti_selezionati = [];
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Selected Spots: " . implode(", ", $posti_selezionati) . "</p>";
                            echo "<p style=\"margin:4px; color: #f29240;\"><strong>WEEK 2:</strong> $date_settimana2</p>";
                        }
                        if ($date_settimana3 != "") {
                        ...
                        <form method="POST" action="confermaPrenotazione.php" id="mainForm">
                            ...
                            <label for="nlettini_settimana2">Select the number of Beach Umbrellas</label>
                            ...
                            <div class="">
                                <label for="">Select the umbrella for the second week:</label>
                            ...
                            <div id="additionalOmbrelloni">
                                ...
                                if (isset($_POST['nlettini_settimana2'])) {
                                    ...
                                    if ($n_ombrelloni >= 2) {
                                        echo "<label for=\"posto2week2\">Select an additional umbrella:</label>";
                                    ...
                                    if ($n_ombrelloni == 3) {
                                        echo "<label for=\"posto3week2\">Select a second additional umbrella:</label>";
...
<script>
    ...
    function updateMapHighlight() {
        ...
        document.querySelectorAll('.circle').forEach(circle => {
            circle.classList.remove('selected-umbrella');
            circle.classList.remove('selected-ombrellone'); // se presente
        });
        ...
        selectedposto1week2s.forEach(posto1week2 => {
            if (posto1week2) {
                ...
                if (circle) {
                    // Aggiunge la classe di evidenziazione (può essere la stessa 'selected-ombrellone' se usata in CSS)
    ...
    function submitFormBack() {
        ...
        form.action = "week1-en.php"; // Sostituisci con la pagina corretta
