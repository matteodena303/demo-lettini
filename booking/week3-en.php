                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        if ($date_settimana2 != "") {
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Selected Spots: " . implode(", ", $posti_selezionati1) . "</p>";
                            echo "<p style=\"margin:4px 4px 0px 4px;\"><strong>WEEK 2:</strong> $date_settimana2</p>";
                            $posti_selezionati2 = [];
                            ...
                            echo "<p style=\"margin:0px 4px 4px 4px;\">Selected Spots: " . implode(", ", $posti_selezionati2) . "</p>";
                        }
                        if ($date_settimana3 != "") {
                            $date_settimana3 = getFormattedWeekRange($id_settimana3);
                            echo "<p style=\"margin:4px;color: #f29240;\"><strong>WEEK 3:</strong> $date_settimana3</p>";
                        }
                        ?>
                        ...
                        <form method="POST" action="confermaPrenotazione.php" id="mainForm">
                            ...
                            <!-- Label in inglese -->
                            <label for="nlettini_settimana3">Select the number of Beach Umbrellas</label>
                            ...
                            <div class="">
                                <label for="">Select the umbrella for the third week:</label>
                            ...
                            <div id="additionalOmbrelloni">
                                ...
                                if (isset($_POST['nlettini_settimana3'])) {
                                    ...
                                    if ($n_ombrelloni >= 2) {
                                        echo "<label for=\"posto2week3\">Select an additional umbrella:</label>";
                                    ...
                                    if ($n_ombrelloni == 3) {
                                        echo "<label for=\"posto3week3\">Select a second additional umbrella:</label>";
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const posto1week2Selects = ['posto1week3', 'posto2week3', 'posto3week3'];
