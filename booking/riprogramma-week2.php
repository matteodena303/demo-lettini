...
$codici_da_rimuovere = array_map('trim', explode(',', $postiWeek2_old));
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        <h2 class="text-body-emphasis">Scegli gli ombrelloni della seconda settimana</h2>
...
<script>
    ...
    function submitForm() {
        ...
        if (numWeeks === 2) {
            ...
            form.action = "riprogramma-week3.php";
        } else {
